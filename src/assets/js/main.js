    ...
    */
    Animations: function() {
        $('#tabs').waypoint(function() {
            ...
            setTimeout(function(){$('#service_1').addClass('animate fadeInDown')},300);
        ...
        $('#gallery1').waypoint(function() {
            setTimeout(function(){$('#galleryintro1').addClass('animated fadeInDown')},0);
            setTimeout(function(){$('#gallerycarousel1').addClass('animated fadeInUp')},700)
        }, { offset: '50%' });
